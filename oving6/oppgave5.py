...
# Output:       Ingen
def print_sentence(streng1,streng2,streng3):
	print(streng1, ' ', streng2, streng3, sep='')
...
def main():
	...
	questions = ['Hva gjør du', 'Hvordan går det', 'Hvorfor heter du','Liker du å hete',  
			'Føler du deg bra', 'Hva har du gjort idag',
